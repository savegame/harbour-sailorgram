    ...
    SilicaFlickable
    {
        ...
        PullDownMenu
        {
            ...
            MenuItem {
                ...
                onClicked: {
                    if (!!rootPage) {
                        rootPage.folder = context.core.sdcardFolder;
                        rootPage.sortRole = FilesModel.NameRole;
                        rootPage.sortOrder = Qt.AscendingOrder;
                        pageStack.pop(rootPage);
                    } else {
                        folder = context.core.sdcardFolder;
                        sortRole = FilesModel.NameRole;
                        sortOrder = Qt.AscendingOrder;
                    }
                }
            ...
            MenuItem {
                ...
                onClicked: {
                    if (!!rootPage) {
                        rootPage.folder = context.core.homeFolder;
                        rootPage.sortRole = FilesModel.NameRole;
                        rootPage.sortOrder = Qt.AscendingOrder;
                        pageStack.pop(rootPage);
                    } else {
                        folder = context.core.homeFolder;
                        sortRole = FilesModel.NameRole;
                        sortOrder = Qt.AscendingOrder;
                    }
                }
